        ...
        <div className="container">
          ...
          <div className="grid grid-3">
            <div className="card fade-in" style={{ border: '2px solid #81C784', background: 'white', padding: '2rem', borderRadius: '12px' }}>
              <div className="feature-icon" style={{ fontSize: '3rem', color: '#10b981' }}>$</div>
        ...
        <div className="container">
          ...
          <div className="grid grid-3">
            <div className="card" style={{ background: 'white', padding: '2rem', borderRadius: '12px', textAlign: 'center' }}>
              <div style={{ fontSize: '2.5rem', marginBottom: '1rem', color: '#10b981', fontWeight: 'bold' }}>1</div>
            ...
            <div className="card" style={{ background: 'white', padding: '2rem', borderRadius: '12px', textAlign: 'center' }}>
              <div style={{ fontSize: '2.5rem', marginBottom: '1rem', color: '#10b981', fontWeight: 'bold' }}>2</div>
            ...
            <div className="card" style={{ background: 'white', padding: '2rem', borderRadius: '12px', textAlign: 'center' }}>
              <div style={{ fontSize: '2.5rem', marginBottom: '1rem', color: '#10b981', fontWeight: 'bold' }}>3</div>
        ...
        <div className="container">
          <div className="cta-section" style={{ background: 'linear-gradient(135deg, #10b981, #059669)', color: 'white', padding: '3rem', borderRadius: '16px', textAlign: 'center' }}>
            ...
            <div className="cta-buttons" style={{ display: 'flex', gap: '1rem', justifyContent: 'center', flexWrap: 'wrap' }}>
              <Link to="/deals" className="btn" style={{ background: 'white', color: '#10b981', padding: '0.875rem 2rem', borderRadius: '8px', textDecoration: 'none', fontWeight: '600', display: 'inline-block', transition: 'all 0.3s ease' }}>
                See How It Works
              </Link>
              {!isAuthenticated() && (
                <Link to="/register" className="btn btn-outline" style={{ background: 'transparent', borderColor: 'white', color: 'white', border: '2px solid white', padding: '0.875rem 2rem', borderRadius: '8px', textDecoration: 'none', fontWeight: '600', display: 'inline-block', transition: 'all 0.3s ease' }}>
