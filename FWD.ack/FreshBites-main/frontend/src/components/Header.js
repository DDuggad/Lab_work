        ...
        <div className="header-content">
          ...
          <nav className={`nav ${isMobileMenuOpen ? 'mobile-open' : ''}`}>
            <ul className="nav-links">
              ...
              {isVendor() && (
                <>
                  ...
                  <li>
                    <Link to="/vendor/manage-deals" className="nav-link" onClick={closeMobileMenu}>Manage Deals</Link>
                  </li>
                </>
              )}
            </ul>
            ...
            <div className="auth-buttons">
              {isAuthenticated() ? (
                <>
                  <span className="user-greeting" style={{ marginRight: '1rem', color: 'var(--primary-green)', fontWeight: '600' }}>
